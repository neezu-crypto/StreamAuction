...
// ===== 경매 등록 =====
export async function registerAuction({soopId, displayName, startPrice, type, consentAgreed}) {
  const result = await registerAuctionFn({soopId, displayName, startPrice, type, consentAgreed});
  return result.data;
}
